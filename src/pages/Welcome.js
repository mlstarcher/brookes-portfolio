...
export default function Welcome() {
  return (
    <div className="sm:pl-20 grid grid-cols-12 sm:mb-32 mb-16 mt-8 sm:-mt-8">
      ...
      <div className="flex justify-center items-center mb-8 sm:mb-16 sm:mb-0 col-span-12 sm:col-start-7 sm:col-end-13">
        <div>
          <img
            src={portrait}
